...
if(option == "Pregnancies"):
  ...
  st.sidebar.write("Insulin is a hormone made in your pancreas, a gland located behind your stomach. Insulin allows your body to use glucose for energy. Glucose is a type of sugar found in many carbohydrates.")
  st.sidebar.write("Insulin also helps balance your blood glucose levels. ")
  st.sidebar.write("Diabetes occurs when your body do not use insulin properly or make enough insulin.")
  st.sidebar.write("The normal range of fasting insulin varies somewhat between labs, but around 2 to 20 mIU/mL is considered normal by most. ")
  
elif(option == "BMI"):
  st.sidebar.write("Body mass index with weight/height (kg/m squared)")
  st.sidebar.write("Body Mass Index (BMI) is a person’s weight in kilograms (or pounds) divided by the square of height in meters (or feet)")
  st.sidebar.write(" Any increase in BMI above normal weight levels is associated with an increased risk of being diagnosed as having complications of diabetes mellitus.")


elif(option == "DiabetesPedigreeFunction"):
  st.sidebar.write("Diabetes pedigree function (a function which scores likelihood of diabetes based on family history)")
